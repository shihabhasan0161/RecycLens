...
import { Mic, Loader2, Power, Camera, Home } from 'lucide-react';

interface AskGeminiViewProps {
  onBack: () => void;
}

export const AskGeminiView: React.FC<AskGeminiViewProps> = ({ onBack }) => {
    ...
    <div className="relative w-full h-screen bg-gray-900 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full p-6 z-10 flex justify-between items-start bg-gradient-to-b from-black/80 to-transparent">
        ...
        <div className="flex items-center gap-3">
            ...
            <button onClick={onBack} className="bg-white/10 backdrop-blur-md p-2 rounded-full border border-white/10 text-white hover:bg-white/20 transition-colors">
      ...
      <div className="absolute bottom-0 left-0 w-full z-20 bg-gradient-to-t from-black/95 via-black/80 to-transparent pb-8 pt-12 px-6">
        ...
        <div className="flex justify-center items-center gap-6">
          <button
            ...
            className={`
              relative flex items-center justify-center w-20 h-20 rounded-full shadow-lg transition-all duration-300 transform hover:scale-105 active:scale-95 pointer-events-auto
              ${connectionState === ConnectionState.CONNECTED 
